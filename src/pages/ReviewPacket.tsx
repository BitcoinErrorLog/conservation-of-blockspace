...
export function ReviewPacket() {
  return (
    <article className="page page-stack">
      ...
      <section className="section-stack">
        ...
        <li>
          <strong>Numeric tables</strong> — verify the 1-day, 14-day, and 28-day exit-unit rows against the toy.
        </li>
        <li>
          <strong>Instantiations</strong> — Lightning <code>e</code> profile vs your measured closes; Ark and
          operator-assisted template values marked illustrative unless a concrete transaction trace is supplied.
        </li>
        <li>
      ...
      <section className="heading-group">
        <h2>Changelog</h2>
        <p>
          Current release: v1.10.3, centered on exit-unit accounting, block-weight bounds, current relay-policy
          status, CSV/challenge timing clarification, and the 1-day / 14-day / 28-day enforcement-window framing.
        </p>
      </section>
      ...
      <section className="section-stack">
        ...
        <li>Cooperative paths excluded unless each exit unit can still secure an operator-independent L1 claim alone.</li>
        </ul>
      </section>
  ...
  year={2026},
  note={Manuscript v1.10.3; source blockspace-conservation-may-2026.tex}
}`}
        </pre>
      </section>
    </article>
